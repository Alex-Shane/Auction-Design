...
public class Tester3 {//speical case: a bidder makes the same bid.
	public static void main (String[] args) {
		...
		theiss.makeBid(11, Benz);//theiss makes the same bid again. System will not let a duplicate bid be listed. 
